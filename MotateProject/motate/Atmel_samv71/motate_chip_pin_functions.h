...
#ifdef PIOC
    _MAKE_MOTATE_SPI_MISO_PIN('C', 26, /* SPINum:*/ 1, /* Peripheral */ C);
    _MAKE_MOTATE_SPI_MOSI_PIN('C', 27, /* SPINum:*/ 1, /* Peripheral */ C);
    _MAKE_MOTATE_SPI_SCK_PIN ('C', 24, /* SPINum:*/ 1, /* Peripheral */ C);
#endif // PIOC
